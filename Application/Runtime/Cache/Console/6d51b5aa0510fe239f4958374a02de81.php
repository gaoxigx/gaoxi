    ...
    <li><label>经纪人<b>*</b></label>  
        <div class="vocation uew-select">
            <select name="agent" class="uew-select-value">
                <?php if(is_array($agent)): $i = 0; $__LIST__ = $agent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo1["id"]); ?>" <?php if($vo1['id'] == $info['agent']): ?>selected="selected"<?php endif; ?>><?php echo ($vo1["username"]); ?>(<?php echo ($vo1["accounts"]); ?>)</option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </li>
    ...
    <li><label>经纪助理编号<b>*</b></label>  
            <div class="vocation uew-select">
                <select name="assistant" class="uew-select-value">
                    <?php if(is_array($assistant)): $i = 0; $__LIST__ = $assistant;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo2["id"]); ?>" <?php if($vo2['id'] == $info['assistant']): ?>selected="selected"<?php endif; ?>><?php echo ($vo2["username"]); ?>(<?php echo ($vo2["accounts"]); ?>)</option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
    </li>
    <li><label>设备编号<b>*</b></label>  
        <div class="vocation uew-select">
            <select name="equipment" class="uew-select-value">
                <?php if(is_array($equipment)): $i = 0; $__LIST__ = $equipment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo3["id"]); ?>"
                <?php if($vo3['id'] == $info['equipment']): ?>selected="selected"<?php endif; ?>><?php echo ($vo3["xinghao"]); ?>(<?php echo ($vo3["bianhao"]); ?>)</option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </li>
    ...
    <li><label>支付方式<b>*</b></label>  
        <div class="vocation uew-select">
            <select name="Payment_method" class="uew-select-value">
                <?php if(is_array($payment)): $i = 0; $__LIST__ = $payment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo4): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo4["id"]); ?>"
                <?php if($vo4['id'] == $info['payment_method']): ?>selected="selected"<?php endif; ?>><?php echo ($vo4["payment"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </li>

    <li><label>买家微信号<b>*</b></label><input name="buyer_wechat" type="text" class="dfinput" value="<?php echo ($info["buyer_wechat"]); ?>"  /></li>
    <li><label>订单来源<b>*</b></label><input name="source" type="text" class="dfinput" value="<?php echo ($info["source"]); ?>"  /></li>
    <li><label>收件人姓名<b>*</b></label><input name="username" type="text" class="dfinput" value="<?php echo ($info["username"]); ?>"  /></li>
    <li><label>收件人电话<b>*</b></label><input name="mobile" type="text" class="dfinput" value="<?php echo ($info["mobile"]); ?>"  /></li>
    <li><label>收件人地址<b>*</b></label><input name="address" type="text" class="dfinput" value="<?php echo ($info["address"]); ?>"  /></li>
    <li><label>订单备注<b>*</b></label><input name="note" type="text" class="dfinput" value="<?php echo ($info["note"]); ?>"  /></li>
...
<input id="shuliang"  name="pro_num" type="text" value="0" class="totprice"  />
    ...
    <li><label>&nbsp;</label><input name="" type="button" onclick="javascript:window.location='../../plist'"  class="btn" value="返回"/></li>
