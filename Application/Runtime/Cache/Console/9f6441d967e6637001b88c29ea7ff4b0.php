...
<body>
    ...
    <div class="itab">
    <ul> 
    <li><a href="#tab1" >添加新建组</a></li> 
    <li><a href="#tab2" class="selected">组成员列表</a></li> 
    </ul>
    </div> 
    ...
    <ul class="forminfo">
    <form name="form1" id="form1" method='post' action="/index.php/Console/Group/insert">
    <li><label>组名称<b>*</b></label><input id="rolename" name="rolename" type="text" class="dfinput" value=""  /></li>
   
    <li><label>备注信息</label>
    

    
    <textarea class="textinput" rows="" cols="" name="depiction"></textarea>
