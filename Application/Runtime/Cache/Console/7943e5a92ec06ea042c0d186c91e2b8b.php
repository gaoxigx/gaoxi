...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a href="/index.php/Console/Personnel/add"><span><img src="/Public/Console/images/t01.png" /></span>添加</a></li>
<!--         <li class="click"><span><img src="/Public/Console/images/t02.png" /></span>修改</li>
    ...
    <table class="tablelist">
        ...
        <td><a href="/index.php/Console/Personnel/edit/id/<?php echo ($vo["id"]); ?>" class="tablelink">修改</a><a href="/index.php/Console/Personnel/delete/id/<?php echo ($vo["id"]); ?>" class="tablelink"> 删除</a></td>
