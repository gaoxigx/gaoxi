...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="rightinfo">
            ...
            <div class="tools">
                <ul class="toolbar">
                    <li><a href="/index.php/Console/Wecate/add"><span><img src="/Public/Console/images/t01.png" /></span>添加</a></li>
            ...
            <table class="tablelist">
                ...
                <tbody>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; var_dump($list)?>
                        <tr>
                            ...
                            <td><?php echo ($vo["sex"]); if($vo["sex"] == 1): ?>男<?php elseif($vo["sex"] == 2): ?>女<?php else: ?>未知<?php endif; ?></td>
                            <td><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></td>               
                            <td><?php echo ($vo["backup"]); ?></td>
                            <td><a href="/index.php/Console/Wecate/edit/id/<?php echo ($vo["id"]); ?>" class="tablelink">修改</a><a href="/index.php/Console/Wecate/wecate_delete/id/<?php echo ($vo["id"]); ?>" class="tablelink"> 删除</a></td>
